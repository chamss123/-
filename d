<html dir="ltr" lang="fr" class="offline"><head>
  <meta charset="utf-8">
...
<body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jstcache="0">
          <span jsselect="heading" jsvalues=".innerHTML:msg" jstcache="9">Aucun accès à Internet</span>
          <a id="error-information-button" class="hidden" onclick="toggleErrorInformationPopup();" jstcache="0"></a>
        </h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Aucun accès à Internet</p>
            ...
            <div id="error-information-popup-box" jstcache="0">
              <div id="error-information-popup-content" jstcache="0">
                <div id="suggestions-list" style="" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="16">
                  <p jsvalues=".innerHTML:suggestionsSummaryListHeader" jstcache="18">Voici quelques conseils&nbsp;:</p>
                  <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? 'single-suggestion' : ''" jstcache="19" class="">
                    <li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="21" jsinstance="0">Vérifiez les câbles réseau, le modem et le routeur.</li><li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="21" jsinstance="1">Reconnectez-vous au réseau Wi-Fi</li><li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="21" jsinstance="*2"><a href="javascript:diagnoseErrors()" id="diagnose-link" jstcache="0">Exécutez les diagnostics réseau de Windows</a></li>
                  </ul>
                </div>
  ...
  <div role="application" tabindex="0" title="Jeu du dino, jouer" class="runner-container" style="width: 312px;"><canvas class="runner-canvas" width="624" height="300" style="width: 312px; height: 150px;"></canvas><span class="offline-runner-live-region" aria-live="assertive">Le jeu a commencé.</span></div><label class="slow-speed-option hidden">Vitesse plus lente<input type="checkbox" title="Vitesse plus lente" tabindex="0" checked="checked"><span class="slow-speed-toggle"></span></label><div class="controller hidden"></div></div>
  <div id="sub-frame-error" jstcache="0">
    <!-- Show details when hovering over the icon, in case the details are
         hidden because they're too large. -->
    <div class="icon" jstcache="0"></div>
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Aucun accès à Internet</div>
  </div>
...
class LoadTimeData {
  ...
  console.warn('crbug/1173575, non-JS module files deprecated.');</script><script jstcache="0">const pageData = {"details":"Détails","dinoGameA11yAriaLabel":"Jeu du dino, jouer","dinoGameA11yDescription":"Jeu du dino. Un dinosaure pixelisé traverse un paysage désolé en esquivant les cactus et les ptérodactyles. Lorsque vous entendez un signal audio, appuyez sur Espace pour le faire sauter par-dessus les obstacles.","dinoGameA11yGameOver":"Partie terminée&nbsp;! Votre score est de $1.","dinoGameA11yHighScore":"Meilleur score&nbsp;: $1.","dinoGameA11yJump":"Sautez&nbsp;!","dinoGameA11ySpeedToggle":"Vitesse plus lente","dinoGameA11yStartGame":"Le jeu a commencé.","errorCode":"ERR_INTERNET_DISCONNECTED","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"www.google.com","msg":"Aucun accès à Internet"},"hideDetails":"Masquer les détails","iconClass":"icon-offline","language":"fr","suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"Vérifiez les câbles réseau, le modem et le routeur."},{"summary":"Reconnectez-vous au réseau Wi-Fi"},{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\">Exécutez les diagnostics réseau de Windows\u003C/a>"}],"suggestionsSummaryListHeader":"Voici quelques conseils&nbsp;:","summary":{"failedUrl":"https://www.google.com/search?q=ll&oq=ll&aqs=chrome..69i57.961j0j7&sourceid=chrome&ie=UTF-8","hostName":"www.google.com","msg":"Aucun accès à Internet"},"textdirection":"ltr","title":"www.google.com"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>